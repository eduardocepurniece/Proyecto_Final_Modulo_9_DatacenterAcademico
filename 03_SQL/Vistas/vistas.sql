...
CREATE OR ALTER VIEW dbo.vw_VentasGenerales
AS
SELECT 
    V.VentaID,
...
CREATE OR ALTER VIEW dbo.vw_DetalleVentas
AS
SELECT 
    V.VentaID,
    V.FechaVenta,
...
CREATE OR ALTER VIEW dbo.vw_ResumenVentasPorCliente
AS
SELECT 
    C.ClienteID,
    C.Nombre + ' ' + C.Apellido AS Cliente,
...
CREATE OR ALTER VIEW dbo.vw_ProductosPorCategoria
AS
SELECT 
    P.ProductoID,
    P.NombreProducto,
